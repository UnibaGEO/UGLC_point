...
- <b> OLD DATASET: </b> the contents of this field represent the name of the native dataset used into the UGLC creation:
    ...
    | [16_ETGFI](https://www.sciencebase.gov/catalog/item/583f4114e4b04fc80e3c4a1a)                                                                       | ETGFI - Earthquake-Triggered Ground-Failure Inventories (POINTS) - USGS                        | 115402    | Work in progress [LICENSE](https://creativecommons.org/licenses/by/4.0/)                                                                                        | free      | :heavy_check_mark: |
